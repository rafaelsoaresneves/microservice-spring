package com.rafa.bookservice.response;
...
public class CambioResponse implements Serializable {
    ...
    public CambioResponse(Long id, String from, String to, BigDecimal conversionFactor, BigDecimal convertedValue, String enviroment) {
        this.id = id;
        this.from = from;
        this.to = to;
